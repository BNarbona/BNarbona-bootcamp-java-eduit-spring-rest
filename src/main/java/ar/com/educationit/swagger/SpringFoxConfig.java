package ar.com.educationit.swagger;
...
public class SpringFoxConfig {
	...
	public Docket createRestApi() {
		Docket docket = new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).select()
				.apis(RequestHandlerSelectors.withClassAnnotation(RestController.class))// cuales son las clases que voy
																						// a documentar
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().contact(new Contact("carlos", "http://sitio.com", "email@email.com"))
				.description("Proyecto Rest final, Bootcamp EducactionIt").title("SpringBoot + JWT + Swagger ").build();
	}
}